...
(function ($, win, doc) {
    var CityPicker1 = function (el, options) {
        this.el = $(el);
    ...
    $.fn.CityPicker1 = function (options) {
        return new CityPicker1(this, options);
    }
